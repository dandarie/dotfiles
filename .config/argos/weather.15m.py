...
api_key = '2ba720ac36d6d9e312b5ec597b8de5b7'

# get yours API key for encode location at https://opencagedata.com
geo_api_key = 'd80da808230d464f823ddc2fc558b7c4'
...
def render_wx():
  ...
  if 'city' in weather_data and 'region' in weather_data:
    ...
    print weather_data['city'] + ', ' + weather_data['region'] + ' | href=https://www.meteoblue.com/ro/vreme/s%C4%83pt%C4%83m%C3%A2na/bucure%c8%99ti_rom%c3%a2nia_683506'
  ...
  print '---'
  print 'Powered by DarkSky | href=https://darksky.net/forecast/44.421,26.044/ca12/ro'
